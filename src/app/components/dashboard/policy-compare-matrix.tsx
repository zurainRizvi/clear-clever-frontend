...
import { ArrowLeft, Check, GitCompare, Loader2, Minus } from "lucide-react";
          ...
          <table className="min-w-full text-sm">
            <thead>
              <tr className="bg-gradient-to-r from-primary/10 to-muted/30 border-b border-border">
                <th className="text-left p-4 font-semibold min-w-[200px] sticky left-0 bg-muted/50 z-10 backdrop-blur">
                  Feature
                </th>
